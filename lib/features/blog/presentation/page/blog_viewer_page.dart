              ...
              children: [
                Container(
                 ...
                 Padding(
                  ...
                  child: Text("by:- ${blog.title}",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: AppColors.whiteColor),),
                ),
                 Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text(" 12pm",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: AppColors.whiteColor),),
                    ],
                  ),
                ),
                 Padding(
