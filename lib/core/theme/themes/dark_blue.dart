...
class DarkBlueTheme extends AppCustomTheme {
  // ++++dark Theme +++
  DarkBlueTheme() : super(Brightness.dark);

  @override
  final ColorScheme colorScheme = ColorScheme.dark(
      primary: AppColors.darkGunMetal,
      onPrimary: AppColors.romanSilver,
      surface: AppColors.darkGunMetal.withOpacity(0.7),
      onSurface: AppColors.darkGunMetal,
      secondary: AppColors.whiteColor,
      onSecondary: AppColors.whiteColor,
      primaryContainer: AppColors.darkGunMetal,
      onPrimaryContainer: AppColors.darkGunMetal,
      errorContainer: AppColors.kuCrimson,
      onErrorContainer: AppColors.maroon,
      inversePrimary: AppColors.darkGunMetal,
